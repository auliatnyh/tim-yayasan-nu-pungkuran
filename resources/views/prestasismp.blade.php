<x-layoutsmp>
    ...
    <div class="flex flex-wrap justify-center gap-6 max-w-full mb-20">
        <div class="flex flex-col items-center w-72"> <!-- Lebar kotak disesuaikan -->
            <img class="h-64 w-64 rounded-lg object-cover" src="/img/juarasmp1.png" alt="Kebudayaan Jawa"> 
        ...
        <div class="flex flex-col items-center w-72"> <!-- Lebar kotak disesuaikan -->
            <img class="h-64 w-64 rounded-lg object-cover" src="/img/juarasmp2.png" alt="Bulu tangkis"> 
            <div class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
        ...
        <div class="flex flex-col items-center w-72"> <!-- Lebar kotak disesuaikan -->
            <img class="h-64 w-64 rounded-lg object-cover" src="/img/juarasmp3.png" alt="Basket"> 
            <div class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
        ...
        <div class="flex flex-col items-center w-72"> <!-- Lebar kotak disesuaikan -->
            <img class="h-64 w-64 rounded-lg object-cover" src="/img/juarasmp4.png" alt="Pencak Silat">
            <div class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
