    ...
    <div class="w-full px-8 lg:px-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mx-auto max-w-6xl">
            ...
            <div class="bg-green-300 border border-green-700 rounded-lg p-6 w-full flex items-center justify-center text-center">
                <div>
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Visi</h3> <!-- Ukuran font lebih kecil -->
                    <p class="text-base text-gray-700"> <!-- Ukuran font lebih kecil -->
            ...
            <div class="bg-green-200 border border-green-700 rounded-lg p-6 w-full">
                <h3 class="text-xl font-bold text-gray-800 mb-4 text-center">Misi</h3> <!-- Ukuran font lebih kecil -->
                <ul class="list-disc list-inside text-base text-gray-700 space-y-4"> <!-- Ukuran font lebih kecil -->
